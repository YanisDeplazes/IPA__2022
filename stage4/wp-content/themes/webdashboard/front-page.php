<?php
   ...
   get_template_part( 'template-parts/page/sections/sectionwrapper', 'sectionwrapper', array('key'   => 'intro' , 'box' => true , 'content'   => array('<h1>Hallo, Yanis Deplazes</h1><hr class="fullwidth">') ) ); 
   get_template_part( 'template-parts/page/sections/sectionwrapper', 'sectionwrapper', array('key'   => 'versionstatus' , 'box' => true , 'title'   => 'Version Status', 'content'   => array("CMS", "Server") ) ); 
