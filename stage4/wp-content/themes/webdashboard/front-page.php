<?php
   ...
   get_template_part( 'template-parts/layout/main__content', 'main__content', array('key'   => 'start') );  /* Loading Beginning of main__Content */
   get_template_part( 'template-parts/layout/loader', 'loader'); /* Loading Loader  */
   get_template_part( 'template-parts/page/sections/sectionwrapper', 'sectionwrapper', array('key'   => 'intro' , 'box' => true , 'content'   => array('<h1>Hallo, Yanis Deplazes</h1><hr class="fullwidth">') ) ); /* Intro Box */
