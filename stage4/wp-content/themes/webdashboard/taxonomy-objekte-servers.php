      ...
      <table class="loop">
         ...
         <tbody>
            <tr onclick="window.location.href='../single/index.html'">
               <td class="order1">
                  <h6><a href="../single/index.html" class="nostyle"><?php the_title();?></a></h6>
               </td>
               <td class="order2"><a href="../single/index.html" class="nostyle"><?php the_title();?></a></td>
               <td class="order3"><?php the_title();?></td>
               <td class="right-text order4">
                  <div class="details-wrapper">
                     <a href="../single/index.html" class="nostyle">
