<?php
   /**
    * File Template for displaying archive for Funktionen
    *
    ...
    */
      ...
      get_template_part( 'template-parts/navigation/secondary', 'secondary', array('key'   => 'personen', 'term' => 'Mitarbeiter') ); 
      ...
      get_template_part( 'template-parts/loop/main', 'main', array('key'   => 'mitarbeiter' ) );
